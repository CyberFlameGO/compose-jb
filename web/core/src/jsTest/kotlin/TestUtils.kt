...
class TestScope : CoroutineScope by MainScope() {
    ...
    @Deprecated(
        message = "The intention of this function was to wait for recompositions. Now there is a more specific function",
        replaceWith = ReplaceWith(expression = "waitForRecompositionComplete()"),
        level = DeprecationLevel.WARNING
    )
    // TODO: remove this function. It looks like there is no need to keep it
